      ...
      <div className="relative bg-slate-800 rounded-lg border border-slate-700 p-6 w-full max-w-sm mx-4 shadow-xl">
        ...
        <div className="opacity-50">
          <input
            ...
            disabled
            className="w-full px-3 py-2.5 text-sm text-slate-400 placeholder-slate-600 bg-slate-900/30 border border-slate-700 rounded-md cursor-not-allowed mb-3"
          />
          <button
            type="button"
            disabled
            className="w-full bg-slate-600 text-slate-400 font-medium py-2.5 px-4 rounded-md cursor-not-allowed"
          >
            Coming Soon
          </button>
        </div>
