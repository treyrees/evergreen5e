          ...
          <>
            ...
            <form onSubmit={handleEmailSignIn}>
              <input
                ...
                disabled={loading}
                className="w-full px-3 py-2.5 text-sm text-slate-200 placeholder-slate-500 bg-slate-900/50 border border-slate-600 rounded-md focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 disabled:opacity-50 mb-3"
              />
              <button
                type="submit"
                disabled={loading || !email}
                className="w-full bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium py-2.5 px-4 rounded-md transition-colors"
              >
